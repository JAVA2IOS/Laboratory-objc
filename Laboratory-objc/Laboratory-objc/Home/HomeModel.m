...
+ (NSArray<HomeModel *> *)tableDatasource {
    NSArray *titles = @[@"转场动画", @"粒子效果", @"可排序", @"colleciton可排序", @"音频使用", @"卡片堆叠"];
    NSArray *viewControllers = @[NSStringFromClass([TransitionViewController class]), NSStringFromClass([EmitterViewController class]), NSStringFromClass([EditableViewController class]), NSStringFromClass([EditableCollecitonController class]),NSStringFromClass([AudioViewController class]), NSStringFromClass([StackCardsViewController class])];
