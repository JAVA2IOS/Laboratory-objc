...
+ (NSArray<HomeModel *> *)tableDatasource {
    ...
    NSArray *viewControllers = @[NSStringFromClass([TransitionViewController class]), NSStringFromClass([EmitterViewController class]), NSStringFromClass([EditableViewController class]), NSStringFromClass([EditableCollecitonController class]),NSStringFromClass([AudioViewController class]), NSStringFromClass([StackCardsViewController class]), NSStringFromClass([IGListViewController class]), @"OperationViewController"];
